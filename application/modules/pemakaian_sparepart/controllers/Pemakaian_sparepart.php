...
class Pemakaian_sparepart extends CI_Controller {
    ...
    function data(){
    $this->load->view('v_pemakaian_sparepart_data');
    }

    function editor(){
    $this->load->view('v_pemakaian_sparepart_editor');
    }
    ...
    public function page()
    {
      ...
      $data = $this->M_pemakaian_sparepart->get_data($search,$from_page,$per_page); // ambil data
