...
class Faktur_pembelian extends CI_Controller {
    ...
    function data(){
    $this->load->view('v_faktur_pembelian_data');
    }

    function editor(){
    $this->load->view('v_faktur_pembelian_editor');
    }
    ...
    public function page()
    {
      ...
      $data = $this->M_faktur_pembelian->get_data($search,$from_page,$per_page); // ambil data
